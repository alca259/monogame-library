...
internal sealed class DialogueBoxEditor : BehaviourEditor
{
    public override View BuildInspector(EditorBehaviour behaviour, EditorGameObject owner)
    {
        ...
        {
            layout.Children.Add(BuildBoolField("Visible", visibleEl.GetBoolean(),
                v => SetProperty(behaviour, "Visible", JsonSerializer.SerializeToElement(v))));
        }

        // Position y Size (Vector2)
        ...
        {
            layout.Children.Add(BuildVector2Field("Size", sizeEl,
        ...
        {
            layout.Children.Add(BuildSliderField("Padding", paddingEl.GetDouble(), 0.0, 50.0,
        ...
        {
            layout.Children.Add(BuildColorField("Background", bgEl,
