...
public sealed class BehaviourSkeletonGenerator : ICodeGenService
{
        ...
        IReadOnlyList<string> methods)
    {
        ...
        for (int j = 0; j < methods.Count; j++)
            if (string.Equals(methods[j], "Draw", StringComparison.Ordinal))
            { includesDraw = true; break; }
    ...
    private static void AppendLifecycleMethod(StringBuilder sb, string name)
    {
        switch (name)
        {
            ...
            case "Update":
                ...
                break;
            case "Draw":
                sb.AppendLine("    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)");
                sb.AppendLine("    {");
                sb.AppendLine("        base.Draw(gameTime, spriteBatch);");
                break;
            case "OnDestroy":
